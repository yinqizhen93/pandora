...
func (tc *TaskCreate) SetDescribe(s string) *TaskCreate {
	tc.mutation.SetDescribe(s)
	return tc
}
...
func (tc *TaskCreate) SetCostTime(i int) *TaskCreate {
	tc.mutation.SetCostTime(i)
	return tc
}

// SetNillableCostTime sets the "costTime" field if the given value is not nil.
func (tc *TaskCreate) SetNillableCostTime(i *int) *TaskCreate {
	if i != nil {
		tc.SetCostTime(*i)
	}
	return tc
...
func (tc *TaskCreate) check() error {
	...
	if _, ok := tc.mutation.Describe(); !ok {
		return &ValidationError{Name: "describe", err: errors.New(`ent: missing required field "Task.describe"`)}
	}
	if _, ok := tc.mutation.StartDate(); !ok {
		return &ValidationError{Name: "startDate", err: errors.New(`ent: missing required field "Task.startDate"`)}
	}
	...
	if _, ok := tc.mutation.CreatedBy(); !ok {
		return &ValidationError{Name: "createdBy", err: errors.New(`ent: missing required field "Task.createdBy"`)}
	}
	return nil
}
...
func (tc *TaskCreate) createSpec() (*Task, *sqlgraph.CreateSpec) {
	...
	if value, ok := tc.mutation.Describe(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
	...
	if value, ok := tc.mutation.CostTime(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
