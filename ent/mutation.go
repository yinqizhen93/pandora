...
// AccessApi returns the value of the "accessApi" field in the mutation.
...
// OldAccessApi returns the old "accessApi" field's value of the Role entity.
// If the Role object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
...
// ResetAccessApi resets all changes to the "accessApi" field.
...
// AccessMethod returns the value of the "accessMethod" field in the mutation.
...
// OldAccessMethod returns the old "accessMethod" field's value of the Role entity.
// If the Role object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
...
// ResetAccessMethod resets all changes to the "accessMethod" field.
